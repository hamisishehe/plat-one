...
import { WithdrawDetails } from '../admin-referrals-withdraw/admin-referrals-withdraw.component';
...
export class AdminDashboardComponent implements OnInit {
  usdbalanceDetails: UsdBalanceDetails[] | null = null;
  profitBalance: ProfitBalance[] | null = null;
  ...
  getUsdData(): void {
    this.http
      .get<BalanceDetails[]>(`${environment.baseUrl}/usdt/show-all-balance`)
      .subscribe(
        (data) => {
          this.usdbalanceDetails = data;
        },
...
export interface UsdBalanceDetails {
  id: number;
  availableBalance: number;
  lockedBalance: number;
}
